...
UPDATE_GAP=50
APOLLO_PROJ="random"
APOLLO_SCALE_TYPE="tensor"   # tensor-wise scalar = APOLLO-mini
APOLLO_SCALE=1.0
...
for BETA2 in "${BETA2_LIST[@]}"; do
    ...
    EXP_NAME="llama257M_apollo_mini_${DTYPE}_lr${LR}_wd${WD}_b2${BETA2}_c4"
    echo "==============================================================="
    ...
    torchrun --standalone --nproc_per_node="${NGPUS}" src/main.py \
        ...
        --wandb-tags mem_eff bf16 apollo_mini
