...
for BETA2 in "${BETA2_LIST[@]}"; do
    ...
    EXP_NAME="llama257M_hybrid_lora_base${BASE_OPT}_lora${LORA_OPT}_scope${HYBRID_LORA_SCOPE}_rank${HYBRID_LORA_RANK}_lr${LR}_wd${WD}_b1${BETA1}_b2${BETA2}_fineweb"
    echo "==============================================================="
