...
# exps/llama-12L8H_fineweb_39k/galore_lr1e-4_wd0.1_resume/ckpts/latest/
# move checkpoinst from exps/llama-12L8H_fineweb_39k/galore_lr1e-4_wd0.1/ckpts/2000/ there

torchrun --standalone --nproc_per_node="${NGPUS}" src/main.py \
    --distributed-backend nccl \
    --experiment-name "galore_lr1e-4_wd0.1_resume" \
