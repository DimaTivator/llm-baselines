...
TRUNK_WANDB_GROUP=4xChinchilla_fp8
TRUNK_EXPERIMENT=ademamix_act_fp8_4xC
RESUME_STEP=35325
ITERATIONS=39250
...
torchrun --standalone --nproc_per_node="${NGPUS}" src/main.py \
    ...
    --experiment-name "ademamix_act_fp8_1xC_resume" \
    ...
    --wandb-tags fineweb act_fp8 1xChinchilla ademamix resume
