...
TRUNK_WANDB_GROUP=4xChinchilla
TRUNK_EXPERIMENT=ademamix_lr1e-3_4xC
RESUME_STEP=70650
ITERATIONS=78500
...
torchrun --standalone --nproc_per_node="${NGPUS}" src/main.py \
    ...
    --experiment-name "ademamix_lr1e-3_2xC_resume" \
    ...
    --wandb-group 2xChinchilla_resume \
    --wandb-tags baseline bf16 ademamix resume
