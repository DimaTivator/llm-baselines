#!/usr/bin/env bash
# train_llama_cos_fp8.sh  —  FP8 run with cosine LR schedule.
#
# Architecture: Llama 124M (12L / 768D / 12H), same as train_llama_fp8.sh.
# Differs from train_llama_fp8.sh only in the LR schedule:
...
#
# Usage:
#   bash scripts/train_llama_cos_fp8.sh [NUM_GPUS]
