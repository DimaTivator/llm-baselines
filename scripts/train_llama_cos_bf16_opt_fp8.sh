#!/usr/bin/env bash
# train_llama_cos_bf16_opt_fp8.sh  —  BF16 activations + FP8 optimizer, cosine LR.
#
...
# LR schedule: cosine with 10% warmup (Chinchilla-optimal for 1 GPU: 3.242B tokens).
#
# Usage:
#   bash scripts/train_llama_cos_bf16_opt_fp8.sh [NUM_GPUS]
