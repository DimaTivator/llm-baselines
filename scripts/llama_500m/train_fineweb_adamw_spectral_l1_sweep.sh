...
SPECTRAL_L1_COEF_INPUT=${SPECTRAL_L1_COEF_START_LIST:-"0 0.5 0.7 1 1.2 1.4 1.6 1.8 2 3"}
SPECTRAL_L1_COEF_INPUT=${SPECTRAL_L1_COEF_INPUT//,/ }
read -r -a SPECTRAL_L1_COEF_VALUES <<< "${SPECTRAL_L1_COEF_INPUT//:/ }"
