...
MARGINS="${MARGINS//,/ }"
MARGIN_PRESET="${MARGIN_PRESET:-full}"
case "${MARGIN_PRESET}" in
    full) ;;
    m16_to_650) MARGINS="0 -10 -25 -50 -100 -150 -200 -250 -300 -350 -400 -450 -500 -550 -600 -650" ;;
    *) echo "Unknown MARGIN_PRESET=${MARGIN_PRESET}"; exit 1 ;;
esac
